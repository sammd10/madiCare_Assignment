...
const Hero = () => {
  return (
    <section className=" overflow-hidden " style={{ height: "calc(100vh - 96px)" }}>
        ...
        <div className="col-12 rounded-4 overflow-hidden col-md-6 d-flex align-items-center justify-content-center">
          <div>
            ...
            style={{
              ...
              maxHeight: "100vh", // Prevent image from growing too tall
              width: "100%", // Prevent image from growing too tall
            }}
          />
          </div>
        </div>
